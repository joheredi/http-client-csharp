...
using MoveToNewSubClientClass = _Specs_.Azure.ClientGenerator.Core.ClientLocation._MoveToNewSubClient.MoveToNewSubClient;
using MoveToNewSubClientOptions = _Specs_.Azure.ClientGenerator.Core.ClientLocation._MoveToNewSubClient.MoveToNewSubClientOptions;
