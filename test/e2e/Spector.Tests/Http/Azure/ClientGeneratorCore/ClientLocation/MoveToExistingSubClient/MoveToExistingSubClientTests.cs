...
using MoveToExistingSubClientClass = _Specs_.Azure.ClientGenerator.Core.ClientLocation._MoveToExistingSubClient.MoveToExistingSubClient;
using MoveToExistingSubClientOptions = _Specs_.Azure.ClientGenerator.Core.ClientLocation._MoveToExistingSubClient.MoveToExistingSubClientOptions;
