...
namespace TestProjects.Spector.Tests
{
    public class TestServerBase : IDisposable
    {
        ...
        /// <summary>
        /// Finds node_modules at the repo root (not one level above like the legacy layout).
        /// </summary>
        protected static string GetNodeModulesDirectory()
        {
            ...
            throw new InvalidOperationException($"Cannot find 'node_modules' at '{nodeModulesDirectory}'.");
        }
