...
public partial class MediaTypeClient
    {
        ...
        public MediaTypeClient(Uri endpoint) : this(endpoint, new MediaTypeClientOptions())
        {
        }
...
public partial class StringBody
    {
        ...
        public virtual ClientResult SendAsJson(string text, CancellationToken cancellationToken = default)
        {
            ...
            return SendAsJson(BinaryContentHelper.FromObject(text), cancellationToken.ToRequestOptions());
        }
        ...
        )
        {
            ...
            return await SendAsJsonAsync(BinaryContentHelper.FromObject(text), cancellationToken.ToRequestOptions()).ConfigureAwait(false);
        }
