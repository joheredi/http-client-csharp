...
### InternalsVisibleTo for e2e test projects (task 21.10)

The legacy emitter generates `AssemblyInfo.cs` files with `[assembly: InternalsVisibleTo("TestProjects.Spector.Tests")]` in each generated project. The new emitter uses a centralized `Directory.Build.props` at `temp/e2e/Spector/http/` (generated by `eng/scripts/emit-e2e.ts`) to add `<InternalsVisibleTo Include="Spector.Tests" />` to all generated projects.
