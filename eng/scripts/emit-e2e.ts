...
// ---------------------------------------------------------------------------
// Directory.Build.props — define $(AzureCoreSharedSources) for generated projects
// ---------------------------------------------------------------------------
...
async function generateDirectoryBuildProps(): Promise<void> {
  ...
  await writeFile(propsPath, content, "utf8");
  console.log(`✅ Generated Directory.Build.props → ${propsPath}`);
}
...
async function main(): Promise<void> {
  ...
  // Generate Directory.Build.props with AzureCoreSharedSources for Azure projects
  await generateDirectoryBuildProps();
