...
/**
 * Props for the {@link ClientUriBuilderFile} component.
 */
export interface ClientUriBuilderFileProps {
...
/**
 * Generates the `ClientUriBuilder.cs` internal helper class.
 *
 * This class provides a fluent builder for constructing request URIs with
 * properly encoded path segments and query parameters. It is used by the
 * generated REST client to assemble endpoint URIs from route templates,
 * path parameters, and query parameters.
 *
 * The generated class matches the legacy emitter's output:
 * `src/Generated/Internal/ClientUriBuilder.cs`.
 */
export function ClientUriBuilderFile(props: ClientUriBuilderFileProps) {
  const header = getLicenseHeader(props.options);

  return (
    <SourceFile
      path="src/Generated/Internal/ClientUriBuilder.cs"
      using={[
        "System",
    ...
    >
      ...
      <Namespace name={props.packageName}>
        <ClassDeclaration internal partial name="ClientUriBuilder">
          {code`
